# Agent Note: Distribute the tk runtime and Harness components

Status: implemented
Decision owner: Ruokee
Draft writer: OMP GPT-5.6 Sol

English | [中文](./2026-08-28-distribute-tk-runtime-and-harness-components.zh.md)
...
Components do not contain the runtime, Chinese Skill, another Harness's files, review records, or product source. The [Harness integration Note](./2026-08-28-integrate-tk-with-harnesses.md) owns tool and adapter behavior.
