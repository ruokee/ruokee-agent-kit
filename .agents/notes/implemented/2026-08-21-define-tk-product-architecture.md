# Agent Note: Define the tk product architecture
...
The English Skill defines Agent behavior for tk. The Chinese Skill is a complete alternative with the same semantic coverage. Public documentation records the current product contract. Agent Notes preserve long-lived decisions and their rationale.
...
The following Notes own the detailed contracts within this architecture:
...
- [runtime and component distribution](./2026-08-28-distribute-tk-runtime-and-harness-components.md);
