# Agent Note: Use short-lived branches and squash into main
...
Squashing removes intermediate commit identifiers from public history. Important rationale therefore belongs in Agent Notes, code, or documentation rather than temporary branch commits.
