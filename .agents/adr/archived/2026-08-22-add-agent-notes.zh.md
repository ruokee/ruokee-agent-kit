...
Archived: 2026-09-02
Reversed by: [建立 ADR 机制](./2026-09-02-establish-adr-mechanism.zh.md)
...
完整政策曾位于 `.agents/notes/README.md` 及其中文版本，`.agents/notes/AGENTS.md` 保存简短的子树编辑说明；根目录 `AGENTS.md` 当时只保留触发条件和职责归属摘要。
