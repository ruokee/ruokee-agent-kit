...
6. **Record the decision (07).** Candidates (split to microservices / isolate the read model only / modularize only / do nothing), tradeoffs, assumptions (report load will not grow tenfold), and re-review conditions, written as an Agent Note.
